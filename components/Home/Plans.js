  ...
  return (
            ...
            <table className="w-full">
                ...
                <tbody>
                    <tr>
                        ...
                        <td className="px-4 py-4 text-center border-b border-gray-200">05</td>

                        <td className="px-4 py-4 text-center text-white bg-gray-900 border-b border-white/20">12</td>
    ...
    <div className="block mt-12 border-t border-b border-gray-200 divide-y divide-gray-200 lg:hidden">
        ...
        <div className="grid grid-cols-4 text-center divide-x divide-gray-200">
            ...
            <div className="px-2 py-2">05</div>
