    ...
    <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-x-16 lg:gap-x-24 gap-y-10">
            <div>
                ...
                <blockquote>
                    <p className="mt-6 text-xl leading-relaxed text-white">Unlock the power of your social media success! Schedule a call today and lets propel your business to new heights together.</p>
                </blockquote>
                <p className="mt-6 text-base font-semibold text-yellow-100 underline">Lets Connect</p>
                <p className="mt-1 text-base text-white">Dont miss out on this opportunity! We are eagerly waiting to connect with you and help you achieve social media greatness. Schedule your call now!</p>
            </div>

            <div>
                <div className="overflow-hidden bg-white">
                    <div className="p-8 lg:px-12 lg:py-10">
                        <h3 className="text-2xl font-semibold text-black">Lets connect! Can we schedule a call to discuss your social media needs?</h3>
