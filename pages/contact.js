...
const contact = () => {
  return (
    ...
    <>
    <Head>
        <title>Contact Us - Unboxx Business: Get in Touch with Our Team</title>
        <meta name="description" content="Reach out to us at Unboxx Business for any inquiries or collaborations. Our team is ready to assist you and help elevate your online presence" />
        ...
        <meta property="og:title" content="Contact Us - Unboxx Business: Get in Touch with Our Team" />
        
        <meta property="og:description" content="Reach out to us at Unboxx Business for any inquiries or collaborations. Our team is ready to assist you and help elevate your online presence" />
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl lg:text-5xl">Contact Us - Unboxx Business</h2>
            <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-500"> Get in Touch with Our Team</p>
        </div>
